...
public class ViewCollected extends GameCommand {
    public ViewCollected() {
        super("viewcollected", true, PLAYER_ARGUMENT, PLAYER, GAME);
    }
    ...
    protected void onCommandInternal(CommandSender sender, List<Object> objects) {
        ...
        CollectionGame.openGUI(viewer, player, game, GUIOpenEvent.GUIType.COLLECTED);
    }
}
